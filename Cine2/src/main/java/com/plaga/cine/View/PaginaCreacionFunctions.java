...
import com.plaga.cine.FilesManage.FilesFunction;
...
public class PaginaCreacionFunctions extends javax.swing.JFrame {
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        try {//Se realiza la transformacion de la fecha de Date a LocalDate
            ...
            } else if (fecha.isBefore(cartelera.getStart()) || fecha.isAfter(cartelera.getEnd())) {
                validacion = false;
                error += "La fecha debe ser entre " + cartelera.getStart().toString() + " y " + cartelera.getEnd().toString();
            }
        ...
        if (!validacion) {
            ...
            file = FilesFunction.createFilesFunction(cartelera.getMovie(), hora, min, fecha.toString());
