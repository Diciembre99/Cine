 ...
 */
public class HadlerSAX extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (qName.equalsIgnoreCase("Nombre")) {
            billboardAuxiliar.setMovie(sb.toString());
        } else if (qName.equalsIgnoreCase("Inicio")) {
            billboardAuxiliar.setStart(LocalDate.parse(sb.toString()));
        } else if (qName.equalsIgnoreCase("Final")) {
            billboardAuxiliar.setEnd(LocalDate.parse(sb.toString()));
        } else if (qName.equalsIgnoreCase("Genero")) {
            billboardAuxiliar.setGender(Gender.valueOf(sb.toString()));
